...
`/game/conquest`에서 여섯 진영 중 하나를 골라 1~20탄을 순서대로 정복합니다. 모든 탄에 여섯 팀이 참가하며, 땅은 12개에서 36개까지 늘고 적의 생산·출정 속도도 높아집니다.

- 내 땅에서 다른 땅으로 드래그하거나, 출발지와 도착지를 차례로 누르면 출정합니다. 키보드는 Tab + Enter로 조작합니다.
- 병력의 50%·75%·전부를 보낼 수 있고, 우리 땅에는 지원군을 보낼 수 있습니다. 각 땅은 최대 150명까지 생산합니다.
